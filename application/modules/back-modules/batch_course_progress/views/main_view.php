        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <?= Modules::run('security/create_access', '<a href="' . Modules::run('helper/create_url', 'batch_course_progress/add') . '" class="btn btn-primary "> <i class="fa fa-plus-circle"></i> Tambah Batch Pelatihan</a>'); ?>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover" id="table_data" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><span>Tanggal Pelatihan</span></th>
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table_peserta" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th style="width: 10%;"><span>No</span></th>
                                    <th style="width: 90%;"><span>Nama Peserta</span></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
