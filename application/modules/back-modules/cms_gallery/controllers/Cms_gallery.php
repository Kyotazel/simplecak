...
class Cms_gallery extends BackendController
{
    var $module_name        = 'cms_gallery';
    var $module_directory   = 'cms_gallery';
    var $module_js          = ['cms_gallery'];
    var $app_data           = [];
    ...
    {
        $this->app_data['page_title'] = "CMS GALERI";
        ...
        foreach ($get_all as $item_data) {
            ...
            $html_respon .= '
                <div class="col-lg-2 col-md-3 col-sm-4 mb-3">
                    <div class="border p-1 card thumb text-center">
                        <a href="#" class="image-popup" title="Screenshot-2"> 
                        <img style="height:200px;object-fit:cover;" src="' . base_url('upload/banner/' . $item_data->image) . '" class="thumb-img" alt="work-thumbnail"> </a>
                        <h4 class="text-center tx-14 mt-3 mb-0">' . $item_data->name . '</h4>
                        <div class="ga-border"></div>
                        <p class="text-muted text-center"><small>' . $item_data->description . '</small></p>
                    </div>
