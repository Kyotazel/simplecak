<div class="row row-sm main-content-mail">
    <div class="col-md-12 container_list">
        <div class="card">
            <div class="card-body">
                <div class="mb-3 row">
                    <h3 class="col-md-8">Daftar Peserta yang ditolak</h3>
                </div>
                    ...
                    <table class="table table-bordered table-hover" id="table_data" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th><span>Kembalikan Peserta</span></th>
                                <th class="text-center"><span>Tanggal Pendaftaran</span></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
                        ...
                        <table class="table table-bordered" id="table_peserta" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th><span>Status Peserta</span></th>
...
<div class="modal fade" id="modal_convert_to" aria-hidden="false" role="dialog">
    <div class="modal-dialog modal-md bg-light" role="document">
        <div class="modal-header">
            <h6 class="modal-title">Pindahkan Peserta</h6>
            <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
        </div>
        <div class="modal-body">
            <label for="convert">Status Untuk Pemindahan</label>
