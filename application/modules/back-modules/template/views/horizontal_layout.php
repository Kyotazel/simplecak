...
<body class="horizontalmenu">
    ...
    <!-- Bootstrap js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Chart.Bundle js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/chart.js/Chart.bundle.min.js"></script>

    <!-- Peity js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/peity/jquery.peity.min.js"></script>

    <!-- Flot Chart js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/jquery.flot/jquery.flot.js"></script>
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/jquery.flot/jquery.flot.pie.js"></script>
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/jquery.flot/jquery.flot.resize.js"></script>
    ...
    <!--MutipleSelect js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/multipleselect/multiple-select.js"></script>
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/multipleselect/multi-select.js"></script>

    <!-- Internal Morris js -->
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/raphael/raphael.min.js"></script>
    <script src="<?= base_url('assets/themes/spruhha/') ?>plugins/morris.js/morris.min.js"></script>
    ...
    <!-- Circle Progress js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>js/circle-progress.min.js"></script>
    <script src="<?= base_url('assets/themes/spruhha/') ?>js/chart-circle.js"></script>

    <!-- Dashboard js-->
    <script src="<?= base_url('assets/themes/spruhha/') ?>js/index.js"></script>
