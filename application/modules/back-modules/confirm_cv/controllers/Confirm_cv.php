...
class Confirm_cv extends BackendController
{
    var $module_name = 'confirm_cv';
    var $module_directory = 'confirm_cv';
    var $module_js = ['confirm_cv'];
    var $app_data = [];
    ...
    {
        $this->app_data['page_title']   = 'Konfirmasi Daftar Riwayat Hidup';
    ...
    public function list_data()
    {
        ...
        foreach ($get_all as $data_table) {
            ...
            $array_peserta = [
                ...
                "where" => "id_batch_course = $data_table->id AND status = 1"
            ];
    ...
    public function get_peserta()
    {
        ...
        $get_all = Modules::run("database/find", "tb_batch_course_has_account", ["id_batch_course" => $id_batch_course, 'status' => 1])->result();
