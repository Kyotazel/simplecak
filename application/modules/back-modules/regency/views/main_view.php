<div class="row row-sm main-content-mail">
    <div class="col-md-12 container_list">
        <div class="card">
            <div class="card-body">
                <div class="mb-3 row">
                    <h3 class="col-md-8">Daftar Kecamatan</h3>
                    <div class="col-md-4 text-right">
                        <?= Modules::run("security/create_access", '<a href="javascript:void(0)" class="btn btn-primary btn_add"><i class="fa fa-plus-circle"></i> Tambah Kecamatan </a>') ?>
                    </div>
                </div>
                ...
                <form class="form_input">
                    <div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Masukkan Kecamatan...">
