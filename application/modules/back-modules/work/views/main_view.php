<div class="row row-sm main-content-mail">
    <div class="col-md-12 container_list">
        <div class="card">
            <div class="card-body">
                <div class="mb-3 row">
                    <h3 class="col-md-8">Daftar Bidang Pekerjaan</h3>
                    <div class="col-md-4 text-right">
                        <?= Modules::run("security/create_access", '<a href="javascript:void(0)" class="btn btn-primary btn_add"><i class="fa fa-plus-circle"></i> Tambah Bidang Pekerjaan </a>') ?>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="table_data" style="width: 100%;">
                        <thead>
                            <tr>
                                <th><span>No</span></th>
                                <th><span>Nama Bidang Pekerjaan</span></th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                ...
                <form class="form_input">
                    <div>
                        <div class="form-group">
                            <label for="name">Nama Bidang Pekerjaan</label>
                            <input type="text" class="form-control" name="name" placeholder="Masukkan Bidang Pekerjaan...">
