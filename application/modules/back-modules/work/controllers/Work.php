...
class Work extends BackendController
{
    var $module_name = 'work';
    var $module_directory = 'work';
    var $module_js = ['work'];
    var $app_data = [];
    ...
    {
        $this->app_data['page_title']     = "Bdiang Pekerjaan";
    ...
    public function list_data()
    {
        ...
        $get_all = Modules::run('database/get_all', 'tb_work_field')->result();
        $no = 0;
        $data = [];
    ...
    public function save() {
        ...
        Modules::run('database/insert', 'tb_work_field', $array_insert);
    ...
    public function get_data() {
        Modules::run('security/is_ajax');
        $id = $this->input->post('id');
        $get_data = Modules::run('database/find', 'tb_work_field', ['id' => $id])->row();
    ...
    public function update() {
        ...
        Modules::run('database/update', 'tb_work_field', ['id' => $id], $array_update);
        echo json_encode(['status' => true]);
    }
    ...
    public function delete_data() {
        ...
        Modules::run('database/delete', 'tb_work_field', ['id' => $id]);
        echo json_encode(['status' => true]);
    }
}