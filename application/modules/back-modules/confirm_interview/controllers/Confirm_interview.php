...
class Confirm_interview extends BackendController
{
    var $module_name = 'confirm_interview';
    var $module_directory = 'confirm_interview';
    var $module_js = ['confirm_interview'];
    var $app_data = [];
    ...
    {
        $this->app_data['page_title']   = 'Konfirmasi Wawancara';
    ...
    public function list_data()
    {
        ...
        foreach ($get_all as $data_table) {
            ...
            $array_peserta = [
                ...
                "where" => "id_batch_course = $data_table->id AND status = 3"
            ];
    ...
    public function get_peserta()
    {
        ...
        $get_all = Modules::run("database/find", "tb_batch_course_has_account", ["id_batch_course" => $id_batch_course, 'status' => 3])->result();
