                ...
                <form class="form-input">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" id="birth_date" name="birth_date" class="form-control fc-datepicker" placeholder="Tanggal Lahir" value="<?= isset($data_detail->birth_date) ? $data_detail->birth_date : '' ?>">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group col-md-4">
