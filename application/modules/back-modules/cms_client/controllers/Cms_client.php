...
class Cms_client extends BackendController
{
    var $module_name        = 'cms_client';
    var $module_directory   = 'cms_client';
    var $module_js          = ['cms_client'];
    var $app_data           = [];
    ...
    public function load_data()
    {
        ...
        $get_all = Modules::run('database/find', 'tb_cms_banner', ['isDeleted' => 'N', 'type' => 3])->result();
        $html_respon = '';
