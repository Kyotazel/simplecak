...
class Home extends BackendController
{
    ...
    {
        $credential_data = Modules::run('database/find', 'app_credential', ['id' => $this->session->userdata('us_credential')])->row();
        $file_location = APPPATH . "modules/back-modules/" . $this->module_name . '/views/' . $credential_data->view_file . '.php';
        $view_file = 'empty_dashboard';
        if (file_exists($file_location)) {
            $view_file = $credential_data->view_file;
        }
