                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <select name="id_course" id="id_course" class="form-control select2" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="opening_registration_date" autocomplete="off" id="opening_registration_date" class="form-control datepickera" placeholder="Awal pendaftaran" value="<?= isset($data_detail->opening_registration_date) ? $data_detail->opening_registration_date : '' ?>">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="closing_registration_date">Akhir Pendaftaran</label>
                            <input type="text" name="closing_registration_date" autocomplete="off" id="closing_registration_date" class="form-control datepickera" placeholder="Akhir Pendaftaran" value="<?= isset($data_detail->closing_registration_date) ? $data_detail->closing_registration_date : '' ?>">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="starting_date">Awal Batch Pelatihan</label>
                            <input type="text" name="starting_date" id="starting_date" autocomplete="off" class="form-control datepickera" placeholder="Awal Pelatihan" value="<?= isset($data_detail->starting_date) ? $data_detail->starting_date : '' ?>">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="ending_date">Akhir Batch Pelatihan</label>
                            <input type="text" name="ending_date" id="ending_date" autocomplete="off" class="form-control datepickera" placeholder="Akhir Pelatihan" value="<?= isset($data_detail->ending_date) ? $data_detail->ending_date : '' ?>">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group col-md-12">
