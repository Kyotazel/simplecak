        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <?= Modules::run('security/create_access', '<a href="' . Modules::run('helper/create_url', "batch_course_history/schedule/add/$id") . '" class="btn btn-primary "> <i class="fa fa-plus-circle"></i> Tambah Jadwal pertemuan</a>'); ?>
                    </div>
                </div>
