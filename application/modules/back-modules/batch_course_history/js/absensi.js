...
$(document).ready(function () {
    ...
    table = $('#table_absensi').DataTable({
        "ajax": {
            "url": url_controller + "batch_course_history/schedule/list_peserta" + "?token=" + _token_user,
            "type": "POST",
            "data": { 'id': $("#id").val() }
        },
        "columnDefs": [
...
$(".btn_save").on("click", function () {
    $.ajax({
        'url': url_controller + "batch_course_history/schedule/add_attendance" + "?token=" + _token_user,
        type: "POST",
        dataType: "JSON",
...
$(document).on('click', '.btn_delete_absensi', function () {
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                url: url_controller+'batch_course_history/schedule/delete_data_absensi'+'?token='+_token_user,
                type: "POST",
                dataType: "JSON",
