...
class Confirm_re_confirm extends BackendController
{
    var $module_name = 'confirm_re_confirm';
    var $module_directory = 'confirm_re_confirm';
    var $module_js = ['confirm_re_confirm'];
    var $app_data = [];
    ...
    {
        $this->app_data['page_title']   = 'Konfirmasi Daftar Ulang';
    ...
    public function list_data()
    {
        ...
        foreach ($get_all as $data_table) {
            ...
            $array_peserta = [
                ...
                "where" => "id_batch_course = $data_table->id AND status = 4"
            ];
    ...
    public function get_peserta()
    {
        ...
        $get_all = Modules::run("database/find", "tb_batch_course_has_account", ["id_batch_course" => $id_batch_course, 'status' => 4])->result();
