...
class Confirm_tpa extends BackendController
{
    var $module_name = 'confirm_tpa';
    var $module_directory = 'confirm_tpa';
    var $module_js = ['confirm_tpa'];
    var $app_data = [];
    ...
    {
        $this->app_data['page_title']   = 'Konfirmasi Tes Potensi Akademik';
    ...
    public function list_data()
    {
        ...
        foreach ($get_all as $data_table) {
            ...
            $array_peserta = [
                ...
                "where" => "id_batch_course = $data_table->id AND status = 2"
            ];
    ...
    public function get_peserta()
    {
        ...
        $get_all = Modules::run("database/find", "tb_batch_course_has_account", ["id_batch_course" => $id_batch_course, 'status' => 2])->result();
        ...
        foreach ($get_all as $data_table) {
            ...
            $array_nilai = [
                ...
                "where"     => "id_account = $get_account->id AND a.id_package_question = 8",
                "order_by"  => "id, DESC"
            ];
            $get_nilai = Modules::run('database/get', $array_nilai)->result()[0];
            $nilai = $get_nilai->result_value;
