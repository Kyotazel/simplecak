...
class Education extends BackendController
{
    var $module_name = 'education';
    var $module_directory = 'education';
    var $module_js = ['education'];
    var $app_data = [];
    ...
    {
        $this->app_data['page_title']     = "Pendidikan";
    ...
    public function list_data()
    {
        ...
        $get_all = Modules::run('database/get_all', 'tb_education')->result();
        $no = 0;
        $data = [];
    ...
    public function save() {
        ...
        Modules::run('database/insert', 'tb_education', $array_insert);
    ...
    public function get_data() {
        Modules::run('security/is_ajax');
        $id = $this->input->post('id');
        $get_data = Modules::run('database/find', 'tb_education', ['id' => $id])->row();
    ...
    public function update() {
        ...
        Modules::run('database/update', 'tb_education', ['id' => $id], $array_update);
        echo json_encode(['status' => true]);
    }
    ...
    public function delete_data() {
        ...
        Modules::run('database/delete', 'tb_education', ['id' => $id]);
        echo json_encode(['status' => true]);
    }
}