...
class App_company extends BackendController
{
    var $module_name = 'app_company';
    var $module_directory = 'app_company';
    var $module_js = ['app_company'];
    var $app_data = [];
    ...
    public function index()
    {
        ...
        $this->app_data['page_title']   = "app company";
