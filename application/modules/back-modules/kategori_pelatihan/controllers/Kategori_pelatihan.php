...
class Kategori_pelatihan extends BackendController
{
    var $module_name = 'kategori_pelatihan';
    var $module_directory = 'kategori_pelatihan';
    var $module_js = ['kategori_pelatihan'];
    var $app_data = [];
