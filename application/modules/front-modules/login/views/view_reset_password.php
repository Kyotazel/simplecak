                            ...
                            <div class="card-sigin">
                                ...
                                <div class="card-sigin">
                                    <div class="main-signup-header">
                                        ...
                                        <h5 class="font-weight-semibold mb-4">masukan password baru.</h5>
                                        ...
                                        <div class="html_respon">
                                            <form class="form-reset-password">
                                                ...
                                                <button class="btn btn-main-primary btn-block btn-reset" data-id="<?= $this->encrypt->encode($data_user->id); ?>">Simpan Password <i class="fa fa-sign-in"></i></button>
                                            </form>
                                        </div>
