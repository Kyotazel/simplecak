...
<div class="container-fluid p-0">
    <div class="row no-gutter">
        <!-- The image half -->
        <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-900" style="background: url(<?= base_url('upload/banner/' . $login_background); ?>);background-position:center;background-repeat: no-repeat;object-fit: cover;background-size: cover;">
            <?php
                    ...
                    <div class="row">
                        <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                            <div class="card-sigin">
                                <div class="mb-5 d-flex"> <a href="index.html"><img src="<?= base_url('assets/themes/valex/'); ?>img/logo.png" class="sign-favicon ht-70" alt="logo"></a>
                                </div>
                                <div class="card-sigin">
