...
foreach ($data_detail_bs as $item_detail) {
    if (!isset($array_detail_bs[$item_detail->stuffing_take][$item_detail->category_teus][$item_detail->price])) {
        $array_detail_bs[$item_detail->stuffing_take][$item_detail->category_teus][$item_detail->price_thc] = 0;
    }
    $array_detail_bs[$item_detail->stuffing_take][$item_detail->category_teus][$item_detail->price_thc] += $item_detail->qty;
}
...
$invoice_code['thc'] = $data_invoice->code;
...
<div class="">
    <div class="invoice-header">
        <h1 class="invoice-title">Invoice THC</h1>
    ...
    <div class="row mg-t-20">
        ...
        <div class="col-md">
            ...
            <p class="invoice-info-row"><span>No. Invoice</span> <span><?= $invoice_code['thc']; ?></span></p>
            ...
            <tbody>
                        ...
                        if (!empty($data_invoice)) {
                            ...
                            $discount_form = '
                                    <div class="input-group float-right" style="width: 200px;">
                                        ...
                                        <input value="0" class="form-control  font-weight-bold rupiah count_price_invoice bg-white" data-target="price_thc" data-ppn="' . $ppn_price . '" data-grandtotal="' . $grand_total . '" name="diskon_thc" type="text">
                                    </div>
                                ';
                        }
                ...
                <tr>
                    ...
                    <td class="tx-right" colspan="2">
                        ...
                        ?>
                        <h4 class="tx-primary tx-bold price_thc" data-subtotal="<?= $grand_total; ?>" data-ppn="<?= $ppn_price; ?>" data-grandtotal="<?= $all_grand_total; ?>">Rp.<?= number_format($all_grand_total, 0, '.', '.'); ?></h4>
                    </td>
                </tr>
            </tbody>
        </table>
