...
if (!empty($data_user->image)) {
    ...
    $dir = $base_dir . 'upload/customer/' . $data_user->image;
    if (file_exists($dir)) {
        $image = base_url('upload/customer/' . $data_user->image);
    }
}
                ...
                <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                    <div class="tab-pane active" id="home">
                        <form class="form-update-profile">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="phone_number" value="<?= $data_user->number_phone; ?>" placeholder="telp..">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-2 mt-3">
                                <label for="inputEmail3" class="col-sm-2 control-label text-right">Masukan password</label>
                                <div class="col-sm-5">
                                    <input type="password" class="form-control" name="password" placeholder="masukan password saat ini..">
                                    <span class="help-block"></span>
                                </div>
                                <div class="col-sm-4"><small>(wajib), validasi perubahan </small></div>
                            </div>
                    ...
                    <div class="tab-pane" id="profile">
                        <form class="form-login">
                            ...
                            <hr>
                            <div class="form-group row mb-2">
                                <label for="inputEmail3" class="col-sm-3 control-label text-right">Masukan password</label>
                                <div class="col-sm-5">
                                    <input type="password" class="form-control" name="password_current" placeholder="masukan password saat ini..">
                                    <span class="help-block"></span>
                                </div>
                                <div class="col-sm-4"><small>(wajib), validasi perubahan </small></div>
                            </div>
