...
class Job_seeker extends BackendController
{
    var $module_name = 'job_seeker';
    var $module_directory = 'job_seeker';
    var $module_js = ['job_seeker'];
    var $app_data = [];
    ...
    public function index()
    {
        ...
        $this->app_data['page_title']   = "Pencari Kerja";
