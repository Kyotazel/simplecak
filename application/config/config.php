...
|
*/
// $config['base_url'] = 'http://localhost/start_sport_online/';
...
$config['base_url'] .= "://" . $_SERVER['HTTP_HOST'];
// $config['base_url'] .= str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
$request_uri_custom = $_SERVER['REQUEST_URI'];
$request_uri_custom = substr($request_uri_custom, 1, strlen($request_uri_custom));
...
|--------------------------------------------------------------------------
|
| this configuration are for 
| common module that can be access without validation
...
$config['app_admin_module'] = [
    ...
    'app_module' => 'pengaturan module',
    'app_module_configuration' => 'pengaturan Data module',
    'app_user' => 'data user'
];
...
|
*/
$config['encryption_key'] = '@ivoyages';
